...
class TestSaveAudioWav:
    """Tests for save_audio_wav function."""

    def test_save_audio_wav_creates_file(
        self, tmp_path: Path, sample_audio: AudioData
    ) -> None:
    ...
    def test_save_audio_wav_empty_samples_raises(self, tmp_path: Path) -> None:
...
class TestLoadAudioWav:
    """Tests for load_audio_wav function."""
    ...
    def test_load_audio_wav_file_not_found(self, tmp_path: Path) -> None:
...
class TestSaveVideoFrames:
    ...
    def test_save_video_frames_creates_file(
        self, tmp_path: Path, sample_frames: list[VideoFrame]
    ) -> None:
    ...
    def test_save_video_frames_empty_raises(self, tmp_path: Path) -> None:
    ...
    def test_save_video_frames_uses_correct_codec(
        self, tmp_path: Path, sample_frame: VideoFrame
    ) -> None:
...
class TestSessionRecorder:
    ...
    def test_session_recorder_creates_session_dir(self, tmp_path: Path) -> None:
    ...
    def test_session_recorder_session_id_format(self, tmp_path: Path) -> None:
    ...
    def test_record_turn_creates_turn_dir(
        self, tmp_path: Path, sample_audio: AudioData
    ) -> None:
    ...
    def test_record_turn_increments_turn_number(self, tmp_path: Path) -> None:
    ...
    def test_record_turn_saves_user_audio(
        self, tmp_path: Path, sample_audio: AudioData
    ) -> None:
    ...
    def test_finalize_creates_metadata_file(self, tmp_path: Path) -> None:
    ...
    def test_finalize_metadata_contains_session_info(self, tmp_path: Path) -> None:
    ...
    def test_finalize_includes_custom_metadata(self, tmp_path: Path) -> None:
    ...
    def test_turn_data_includes_files_info(
        self, tmp_path: Path, sample_audio: AudioData, sample_frames: list[VideoFrame]
    ) -> None:
...
class TestLoadSessionMetadata:
    ...
    def test_load_session_metadata_returns_dict(self, tmp_path: Path) -> None:
    ...
    def test_load_session_metadata_file_not_found(self, tmp_path: Path) -> None:
...
class TestRecordingIntegration:
    """Integration tests for recording with orchestrator."""
